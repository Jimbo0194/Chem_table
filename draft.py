...
elementos = {'Hidrogeno': elemento('Hidrogeno', 'No Metal', 'H', 1.0079, 'No Metal', [-1, 1], '+1', (2, 0)),
             ...
             'Vanadio': elemento('Vanadio', 'De Transición', 'V', 50.9415, 'Metal', [2, 3, 4, 5], '+3', (5, 3)),
             'Cromo': elemento('Cromo', 'De Transición', 'Cr', 51.9961, 'Metal', [6, 3, 2], '+4 y +5', (5, 4)),
             'Manganeso': elemento('Manganeso', 'De Transición', 'Mn', 54.938049, 'Metal', [7, 6, 4, 2, 3], '+2', (5, 5)),
             'Hierro': elemento('Hierro', 'De Transición', 'Fe', 55.847, 'Metal', [2], '+2 y +3', (5, 6)),
             'Cobalto': elemento('Cobalto', 'De Transición', 'Co', 58.933200, 'Metal', [2, 3], '+3', (5, 7)),
             'Níquel': elemento('Níquel', 'De Transición', 'Ni', 58.6934, 'Metal', [2, 3], '+2', (5, 8)),
             ...
             'Bromo': elemento('Bromo', 'Halógeno', 'Br', 79.904, 'No Metal', [1, -1, 3, 5, 7], '-1', (5, 15)),
             ...
             'Talio': elemento('Talio', 'Metales del bloque p', 'Tl', 204.3833, 'Metal', [1, 3], '+3', (7, 11)),
             'Plomo': elemento('Plomo', 'Metales del bloque p', 'Pb', 207.2, 'Metal', [2, 4], '+2', (7, 12)),
             'Bismuto': elemento('Bismuto', 'Metales del bloque p', 'Bi', 208.980386, 'Metal', [3, 5], '+3', (7, 13)),
             'Polonio': elemento('Polonio', 'Metaloide', 'Po', 209.9824, 'Metaloide', [4, 8], 'N/A', (7, 14)),
             'Ástato': elemento('Ástato', 'Halógeno', 'At', 210, 'Metal', [0], 'N/A', (7, 15)),
             ...
             'Meitnerio': elemento('Meitnerio', 'De Transición', 'Mt', 268, 'Metal', [0], 'N/A', (8, 7)),
             'Darmstadio': elemento('Darmstadio', 'De Transición', 'Ds', 281, 'Metal', [0], 'N/A', (8, 8)),
             'Roetgenio': elemento('Roetgenio', 'De Transición', 'Rg', 282, 'Metal', [0], 'N/A', (8, 9)),
             'Copernicio': elemento('Copernicio', 'De Transición', 'Cn', 285, 'Metal', [0], 'N / A', (8, 10)),
             'Nihonio': elemento('Nihonio', 'Metales del bloque p', 'Nh', 286, 'Metal', [0], 'N/A', (8, 11)),
             'Flerovio': elemento('Flerovio', 'Metales del bloque p', 'F', 287, 'Metal', [0], 'N/A', (8, 12)),
             'Moscovio': elemento('Moscovio', 'Metales del bloque p', 'Nh', 286, 'Metal', [0], 'N/A', (8, 13)),
             'Livermorio': elemento('Livermorio', 'Metales del bloque p', 'Lv', 291, 'Metal', [0], 'N/A', (8, 14)),
             'Teneso': elemento('Teneso', 'Halógeno', 'Ts', 294, 'No Metal', [0], 'N/A', (8, 15)),
